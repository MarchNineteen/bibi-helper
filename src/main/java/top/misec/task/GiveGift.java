...
public class GiveGift implements Task {
    ...
    public JsonArray xliveGiftBagList() {
        JsonElement element = HttpUtil.doGet("https://api.live.bilibili.com/xlive/web-room/v1/gift/bag_list")
                .get("data").getAsJsonObject()
                .get("list");
        return !element.isJsonNull() ? element.getAsJsonArray() : new JsonArray();
    }
